...
1. `stationary_sound@ sound_manager::play(const string &in filename, bool looping = false, bool persist = false, bool wait = false, bool immediate = true, float pan = 0, float pitch = 100, double volume = 0, string[]@ fx = null, const string &in owner = "");`
...
- `float pitch = 100`: The pitch of the sound.
